...
#                t = datetime.datetime.strptime(dirName , "%Y-%m-%d")
                ...
                for subroot, subdirs, subfiles in os.walk(subdirpath):
                    ...
                    for file in subfiles:                    
                        ...
                        tup=(latency_data , timestamp_data, datetime.datetime.fromtimestamp(timestamp_data).strftime('%d/%m %H:%M'), numpy.average(latency_data),ip_data)
    ...
    print 'rtt_list',rtt_list
    ax1.boxplot(rtt_list)                                
                                                
    ax2 = fig.add_subplot(k,1,2)#,axisbg='grey')
